...
- Commit/publish reviewable work. Keep `main` as the reviewed baseline. CH05 has a published literature gate and conditional timing model; physical timing is on hold. CH06 has a published survey and candidate host model, with ABI/physical link on hold. CH07 is next under the user’s broad authorization and needs its own survey and approved electrode/quality inputs before topology selection. CH03 battery and CH04 host/memory physical feasibility remain on hold pending measured inputs.
