...
- Commit/publish reviewable work. Keep `main` as the reviewed baseline. At present CH05 has a published literature gate and conditional timing model; its physical timing feasibility is on hold. CH06 and circuit design await explicit instruction and their own entry gates. CH03 battery and CH04 host/memory physical feasibility remain on hold pending measured inputs.
