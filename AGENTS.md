...
- Commit/publish reviewable work. Keep `main` as the reviewed baseline. At present the program has stopped at the CH04 **synthetic model** gate; CH05 and circuit design await explicit instruction and their own entry gates. CH03 battery and CH04 host/memory physical feasibility remain on hold pending measured inputs.
