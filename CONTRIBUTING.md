...
1. Read `README.md`, `state/PROJECT_STATE.md`, `state/CHUNK_STATUS.csv` and the current open issues. Work on an explicitly authorized bounded chunk; CH04 and later design are paused until the user instructs otherwise. CH03's synthetic model gate does not approve physical feasibility.
