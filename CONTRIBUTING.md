...
1. Read `README.md`, `state/PROJECT_STATE.md`, `state/CHUNK_STATUS.csv` and the current open issues. Work on an explicitly authorized bounded chunk; CH03 and later design are paused until the user instructs otherwise.
