...
Qualitative screening only, updated 2026-09-25. Impact `I` and likelihood `L` use 1 (low) to 5 (high); the product is a **ranking aid, not a measured probability**. Product/safety owner review is still pending after CH03. All risks are open.
...
| R-010 | Candidate feature load consumes 10% reserve | 4 | 5 | 20 | Architecture | CH02 estimates 78–94 sensor signal contacts before power/test/RF; CH03 provides only synthetic power sensitivities; CH04 transport study and approved denominator still needed; OI-007 |
