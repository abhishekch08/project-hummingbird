...
| R-013 | High-rate timestamp/framing floods host and FIFO | 4 | 4 | 16 | Digital architecture | CH06 adds candidate CRC/framing/ACK/GAP and shows 16 MHz research average deficit, but no measured link or burst feasibility; selected host errata, measured links, loss policy, SRAM/DMA and CH19 integration needed; OI-013 |
...
| R-016 | EEG/ECG contact mismatch, offsets and motion defeat nominal AFE CMRR/noise/headroom | 5 | 4 | 20 | Sensors + analog + algorithms | CH07 synthetic 1 V common mode creates 55/100 µV mismatch residual even with assumed 100 dB intrinsic CMRR; chosen DC gains saturate for ±300 mV offsets. Measure complex electrodes and artifact distributions; set quality/recovery targets and pad/ESD leakage before topology; OI-004/005 |
