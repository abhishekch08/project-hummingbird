...
**Current status:** The [dated CH05 timebase/CDC survey](timing/2026-09-25_STATE_OF_ART_REVIEW.md) and quantitative trade study were merged as PR #7 **before** CH05's model. The [CH06 host/register survey](host_interface/2026-09-25_STATE_OF_ART_REVIEW.md) is the prerequisite to a conditional CH06 contract, with physical link/ABI freeze held. Neither survey satisfies CH07 or any later block-specific literature gate. See `MASTER_SPEC.md` §0.7 and §59.
