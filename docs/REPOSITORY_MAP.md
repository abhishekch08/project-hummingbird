...
| `docs/literature/` | Block-specific, dated, benchmarked surveys with primary citations | CH05 and CH06 surveys merged before each model; CH07 biopotential survey at entry gate before numerical model. Later blocks need separate reviews. |
